...
@Component({
	selector: 'authorization-details-widget',
	templateUrl: './authorization-details-widget.component.html',
  styleUrls: ['./authorization-details-widget.component.css'] 
})
export class AuthorizationDetailsWidgetComponent implements OnInit {
  debugger
