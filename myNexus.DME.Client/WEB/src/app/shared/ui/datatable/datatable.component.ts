...
export class DatatableComponent implements OnInit {
  ...
  render() {
    ...
    options = $.extend(options, {
      'dom': '<\'dt-toolbar\'<\'col-xs-12 col-sm-6\'f><\'col-sm-6 col-xs-12 hidden-xs text-right\'' + toolbar + '>r> t' +
    ...
    if (!toolbar) {
      element
        ...
        .append(`<div class="text-right">
                      <img src="assets/img/logo-transparent.png" alt="SmartAdmin" style="width: 111px; margin-top: 3px; margin-right: 10px;">
                 </div>`);
    }
